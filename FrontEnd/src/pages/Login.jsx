        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center cursor-pointer">
              <input type="checkbox" className="w-4 h-4 bg-gray-900 border-gray-600 text-indigo-500 rounded focus:ring-indigo-500 focus:ring-offset-gray-800" />
              <span className="ml-2 text-gray-300">Remember me</span>
            </label>
            <button type="button" onClick={() => {}} className="text-indigo-400 hover:text-indigo-300 font-medium">
              Forgot password?
            </button>
          </div>
