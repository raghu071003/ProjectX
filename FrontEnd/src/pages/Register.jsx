...
export default function Register() {
  ...
  const submit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      const { confirmPassword, ...registerData } = form; // Don't send confirmPassword to backend
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-2xl p-8 w-full max-w-md">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`block w-full pl-10 pr-3 py-3 bg-gray-900 border ${
                  validationErrors.name ? "border-red-500 focus:ring-red-500" : "border-gray-600 focus:ring-indigo-500"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                name="email"
                className={`block w-full pl-10 pr-3 py-3 bg-gray-900 border ${
                  validationErrors.email ? "border-red-500 focus:ring-red-500" : "border-gray-600 focus:ring-indigo-500"
                } rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:border-transparent transition duration-200 outline-none`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                name="password"
                className={`block w-full pl-10 pr-3 py-3 bg-gray-900 border ${
                  validationErrors.password ? "border-red-500 focus:ring-red-500" : "border-gray-600 focus:ring-indigo-500"
                } rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:border-transparent transition duration-200 outline-none`}
                placeholder="••••••••"
                value={form.password}
                onChange={onChange}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`block w-full pl-10 pr-3 py-3 bg-gray-900 border ${
                  validationErrors.confirmPassword ? "border-red-500 focus:ring-red-500" : "border-gray-600 focus:ring-indigo-500"
                } rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:border-transparent transition duration-200 outline-none`}
                placeholder="••••••••"
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div id="google-signin-btn-register" className="flex justify-center h-[42px] overflow-hidden rounded-lg"></div>
