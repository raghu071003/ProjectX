export default function TestCasesPanel({ testCases }) {
  ...
  return (
    <div className="p-4 border rounded-lg bg-white space-y-3">
      <h2 className="font-semibold text-lg text-black">Test Cases</h2>
      ...
      {visibleCases.map((tc, index) => (
        ...
        >
          ...
          <div className="mt-2 text-sm">
            <p className="font-semibold text-black">Input</p>
            <pre className="bg-white p-2 rounded border overflow-x-auto text-black">
              {tc.input}
            </pre>
          </div>

          <div className="mt-2 text-sm">
            <p className="font-semibold text-black">Expected Output</p>
            <pre className="bg-white p-2 rounded border overflow-x-auto text-black">
              {tc.expectedOutput}
            </pre>
          </div>
